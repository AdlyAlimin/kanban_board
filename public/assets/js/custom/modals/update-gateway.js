...
var KTModalNewTarget = (function () {
    ...
    return {
        init: function () {
            (i = document.querySelector("#kt_modal_update_gateway")) &&
                ((o = new bootstrap.Modal(i)),
                (a = document.querySelector("#kt_modal_update_gateway_form")),
                (t = document.getElementById("kt_modal_update_gateway_submit")),
                (e = document.getElementById("kt_modal_update_gateway_cancel")),
